...
/* harmony import */ var ngx_stripe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngx-stripe */ "./node_modules/ngx-stripe/fesm2015/ngx-stripe.js");
...
let UserPaymentsCreateStripChargeComponent = class UserPaymentsCreateStripChargeComponent extends _core_components_form_component__WEBPACK_IMPORTED_MODULE_2__["FormComponent"] {
    constructor(appStripeService, injector) {
        super(injector);
        this.appStripeService = appStripeService;
        this.stripeTokenReceived = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.cardOptions = {
            style: {
                base: {
                    iconColor: '#666EE8',
...
UserPaymentsCreateStripChargeComponent.ctorParameters = () => [
...
let UserPaymentsCreateStripeChargeModalContentComponent = class UserPaymentsCreateStripeChargeModalContentComponent extends _core_components_modals_base_modal_content_component__WEBPACK_IMPORTED_MODULE_2__["BaseModalContentComponent"] {
...
UserPaymentsCreateStripeChargeModalContentComponent.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let UserPaymentsCreateStripeChargeModalComponent = class UserPaymentsCreateStripeChargeModalComponent extends _core_components_modals_base_modal_component__WEBPACK_IMPORTED_MODULE_2__["BaseModalComponent"] {
    constructor(injector) {
        super(injector);
    }
    initializeComponent() {
    ...
    openModal() {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield _super.open.call(this, _user_payments_components_user_payments_create_stripe_charge_modal_user_payments_create_stripe_charge_modal_content_user_payments_create_stripe_charge_modal_content_component__WEBPACK_IMPORTED_MODULE_3__["UserPaymentsCreateStripeChargeModalContentComponent"]);
        });
    }
};
UserPaymentsCreateStripeChargeModalComponent.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let UserPaymentsCreateUserPaymentComponent = class UserPaymentsCreateUserPaymentComponent extends _core_components_base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    constructor(userPaymentsService, injector) {
        super(injector);
        this.userPaymentsService = userPaymentsService;
        this.userPaymentCreated = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    initializeComponent() {
    }
    createRequestData(amount, token, description) {
    ...
    createUserPayment(request) {
        this.userPaymentsService.createUserPayment(request)
            .pipe(_core_commons_service__WEBPACK_IMPORTED_MODULE_5__["CommonsService"].deserializeMap(CreateUserPayment.Response)).subscribe(value => {
            this.userPaymentCreated.emit(value);
        });
    }
};
UserPaymentsCreateUserPaymentComponent.ctorParameters = () => [
...
let UserPaymentsCreateUserPaymentNoTemplateComponent = class UserPaymentsCreateUserPaymentNoTemplateComponent extends UserPaymentsCreateUserPaymentComponent {
};
...
let UserPaymentsDetailsComponent = class UserPaymentsDetailsComponent extends _core_components_base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    constructor(userPaymentsService, injector) {
        super(injector);
        this.userPaymentsService = userPaymentsService;
        this.userPaymentReceived = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.getUserPayment = (request) => {
            this.userPaymentsService.getUserPayment(request).pipe(_core_commons_service__WEBPACK_IMPORTED_MODULE_6__["CommonsService"].deserializeMap(GetUserPayment.Response))
                .subscribe(value => {
...
(function (UserPaymentRequests) {
    ...
    (function (CreateUserPayment) {
        ...
        let Response = class Response extends UserPayment {
        };
...
let UserPaymentsPipe = class UserPaymentsPipe {
...
let UserPaymentsService = class UserPaymentsService extends _core_http_rest_service__WEBPACK_IMPORTED_MODULE_2__["RestService"] {
    constructor(restangular) {
        super(restangular);
        this.userPaymentsService = this.getService(_user_payments_user_payments_constants__WEBPACK_IMPORTED_MODULE_4__["UserPaymentsConstants"].USERS_PAYMENTS_ENDPOINT);
    }
    createUserPayment(request) {
        return this.userPaymentsService.one('').customPOST(this.serialize(request));
    }
    getUserPayment(request) {
        return this.userPaymentsService.one(request.paymentId).get();
    }
};
UserPaymentsService.ctorParameters = () => [
...
let AppStripeService = class AppStripeService extends _core_http_rest_service__WEBPACK_IMPORTED_MODULE_2__["RestService"] {
    constructor(stripeService, restangular) {
        super(restangular);
...
AppStripeService.ctorParameters = () => [
...
let UserProfilesChatsPageComponent = class UserProfilesChatsPageComponent extends _core_components_page_component__WEBPACK_IMPORTED_MODULE_2__["PageComponent"] {
    constructor(injector) {
        super(injector);
    }
    initializeComponent() {
...
UserProfilesChatsPageComponent.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] }
];
...
let UserProfilesDashboardPageComponent = class UserProfilesDashboardPageComponent extends _core_components_page_component__WEBPACK_IMPORTED_MODULE_2__["PageComponent"] {
    constructor(injector) {
        super(injector);
        this.allUsersProfilesNoTemplateComponentcore = [];
    }
    initializeComponent() { }
};
UserProfilesDashboardPageComponent.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] }
];
...
let UserProfilesEditProfilePageComponent = class UserProfilesEditProfilePageComponent extends _core_components_page_component__WEBPACK_IMPORTED_MODULE_2__["PageComponent"] {
    constructor(injector) {
        super(injector);
    }
    initializeComponent() {
...
UserProfilesEditProfilePageComponent.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] }
];
...
let UserProfilesMainPageComponent = class UserProfilesMainPageComponent {
    constructor() { }
    ngOnInit() { }
};
...
let UserProfilesProfilePageComponent = class UserProfilesProfilePageComponent extends _core_components_page_component__WEBPACK_IMPORTED_MODULE_2__["PageComponent"] {
    constructor(injector) {
        super(injector);
    }
    initializeComponent() { }
};
UserProfilesProfilePageComponent.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] }
];
...
let UserProfilesSettingsPageComponent = class UserProfilesSettingsPageComponent extends _core_components_page_component__WEBPACK_IMPORTED_MODULE_2__["PageComponent"] {
    constructor(injector) {
        super(injector);
    }
    initializeComponent() {
...
UserProfilesSettingsPageComponent.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] }
];
